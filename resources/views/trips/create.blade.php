<x-layout_admin>
    <div class="bg-gray-50 shadow-2xl border border-gray-200 rounded p-10 mx-auto mt-24 max-w-lg">
        <h1 class="text-center text-3xl uppercase mb-2">Create new trip</h1>
        <form action="/trips" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="start_date" class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="end_date" class="border border-gray-200 rounded p-2 w-full"
                    value="{{ old('end_date') }}">
                @error('end_date')
                    <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                @enderror
